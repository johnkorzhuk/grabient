...
import { updateStopColor, updateActiveColorPicker, editStopColor } from './../../store/stops/actions';
...
class ColorPicker extends Component {
  ...
  render() {
    ...
    return (
      ...
      >
        <ChromePicker disableAlpha color={color} onChange={this.handleColorChange} />
