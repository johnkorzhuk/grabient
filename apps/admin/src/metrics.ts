...
export const METRIC: Record<string, MetricDef> = {
  ...
  "d1.likes": { source: "d1", agg: "last", unit: "count", label: "Likes", caveat: "Cumulative.", calendar: "utc" },
  ...
  "d1.signups": { source: "d1", agg: "sum", unit: "count", label: "Signups", caveat: "Daily new accounts.", calendar: "utc" },
  "d1.likes_new": { source: "d1", agg: "sum", unit: "count", label: "New likes", caveat: "Daily likes.", calendar: "utc" },

  "index.corpus": { source: "index", agg: "last", unit: "count", label: "Sitemap URLs", caveat: "URLs in the live sitemap index at sweep time. No history before the first sweep — the API answers only 'now'.", calendar: "utc" },
  "index.inspected": { source: "index", agg: "last", unit: "count", label: "URLs inspected", caveat: "May be < corpus in rotation mode.", calendar: "utc" },
  ...
  "index.not_indexed": { source: "index", agg: "last", unit: "count", label: "Pages not indexed", caveat: "Everything not in the indexed bucket.", calendar: "utc" },
