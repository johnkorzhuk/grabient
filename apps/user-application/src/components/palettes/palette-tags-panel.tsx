    ...
    return (
        <div className="space-y-4">
            <div className="flex items-center justify-between flex-wrap gap-2">
                <h3 className="text-sm font-semibold text-foreground">AI Tags (Admin)</h3>
...
function aggregateTagData(tags: PaletteTagResult[]) {
    ...
    // Enum aggregation with model tracking
    const enums = {
    ...
    // Array aggregation with model tracking
    const arrays = {
    ...
    for (const tag of validTags) {
        ...
        const modelInfo = { model: tag.model, version: tag.promptVersion };
        ...
        // Support both old (color_family) and new (dominant_colors) field names
...
function TagsSummaryView({ tags }: { tags: PaletteTagResult[] }) {
    ...
    // Generate LLM-optimized summary text
    ...
    return (
        <div className="space-y-6">
            ...
            {/* Categorical Attributes - The "Facts" */}
            <div>
...
// Enum vote visualization - shows winner with confidence
...
// Tag distribution - horizontal bars showing frequency
