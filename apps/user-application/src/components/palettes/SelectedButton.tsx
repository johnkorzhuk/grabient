                    ...
                    <TooltipTrigger asChild>
                        <button
                            ...
                            className={cn(
                                ...
                                "h-8.5 w-[88px] border border-solid border-transparent",
                        ...
                        >
                            {isExportOpen ? (
                                <>
                                    <span>Close</span>
                                    <X className="ml-1.5 h-4 w-4" strokeWidth={2.5} />
                                </>
                            ) : (
                                <>
                                    <span>Export</span>
                                    <ArrowRightFromLine className="ml-1.5 h-4 w-4" strokeWidth={2.5} />
                                </>
                            )}
                        </button>
                    </TooltipTrigger>
